...
projectId = "2HaO24oN28OKEggGfGZutl7TOrx"
projectSecret = "e7a0ac89f8201362de743d55a4cc4ab6"
...
def hash_user_file(user_file, file_key):
    ...
    client = ipfshttpclient.connect('/dns/ipfs.infura.io/tcp/5001/https',auth=(projectId, projectSecret))
